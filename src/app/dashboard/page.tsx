...
const Page = async () => {
  ...
  return (
    <div className="flex min-h-screen w-full ">
      <div className="max-w-7xl w-full mx-auto flex flex-col sm:py-4 sm:gap-4">
        <div className="flex flex-col gap-16">
          <div className="grid gap-4 grid-cols-2">
            <Card>
              ...
              <CardFooter>
                <Progress
                  value={(lastWeekRevenue?._sum.amount! / WEEKLY_GOAL) * 100}
                />
              </CardFooter>
            </Card>
            <Card>
              ...
              <CardFooter>
                <Progress
                  value={(lastMonthRevenue?._sum.amount! / MONTHLY_GOAL) * 100}
                />
              </CardFooter>
            </Card>
          </div>
