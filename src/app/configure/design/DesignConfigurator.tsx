...
const DesignConfigurator = ({
  ...
  const saveConfiguration = async () => {
    try {
      ...
      toast({
        title: "Something went wrong",
        description: "Some error occured while updating the configuration",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="relative mt-20 grid grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 aspect-[896/1831] pointer-events-none">
          <AspectRatio
            ref={phoneCaseRef}
            ratio={896 / 1831}
          ...
          <div className="absolute z-40 left-[3px] top-px bottom-px rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)] inset-0 right-[3px]" />
          <div
            className={cn(
      ...
      <div className=" h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div
            ...
            aria-hidden="true"
          />
          <div className="pz-8 pb-12 pt-8">
            <h2 className=" tracking-tight font-bold text-3xl">
              Customize Your case
            </h2>
            <div className="w-full h-px bg-zinc-200 my-6" />
            <div className=" relative m-4 h-full flex flex-col justify-between">
